///////////////////////////////////////////////////////////////////////
//
// triangles_two_attribs.cpp
//
// modified by Minho Kim (minhokim@uos.ac.kr) on 16 September 2014
//
...
void init(void)
{
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(positions_x), positions_x, GL_STATIC_DRAW);
	glVertexAttribPointer(0, 1, GL_FLOAT, GL_FALSE, 0, BUFFER_OFFSET(0));
	glEnableVertexAttribArray(0);

	glBindBuffer(GL_ARRAY_BUFFER, vbo[1]);
	glBufferData(GL_ARRAY_BUFFER, sizeof(positions_y), positions_y, GL_STATIC_DRAW);
