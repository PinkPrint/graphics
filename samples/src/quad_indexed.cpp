...
#define	QUAD_INDEXED	1
#define	QUAD_NON_IDX	2
//#define	QUAD_TYPE	QUAD_INDEXED
#define	QUAD_TYPE	QUAD_NON_IDX


#if	QUAD_TYPE==QUAD_INDEXED
GLuint	vbo_verts, vbo_idx;
#elif	QUAD_TYPE==QUAD_NON_IDX
GLuint	vbo_verts;
#endif
GLuint	vao;
...
//	glVertexAttribPointer(0, 2, GL_FLOAT, GL_FALSE, 0, BUFFER_OFFSET(0));
	glVertexAttribPointer(0, 2, GL_FLOAT, GL_FALSE, sizeof(GLfloat)*5, BUFFER_OFFSET(0));
	glEnableVertexAttribArray(0);

	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(GLfloat)*5, BUFFER_OFFSET(2*sizeof(GLfloat)));
