...
void init(void)
{
	...
	const char	src_vert[] = {
		"#version 330 core	\n"
		"layout(location = 1) in ivec4 vPosition;	\n"
		"void main()	\n"
		"{	\n"
...
#if	USE_NORMALIZE
	glVertexAttribPointer(1, 2, GL_INT, GL_TRUE, 0, BUFFER_OFFSET(0));
#else
	glVertexAttribPointer(1, 2, GL_INT, GL_FALSE, 0, BUFFER_OFFSET(0));
#endif
