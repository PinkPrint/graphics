...
void init(void)
{
	...
	GLuint h_prog = build_program_from_files("xfm_with_glm.vert", "xfm_with_glm.frag");

	glUseProgram(h_prog);

	// How to use the first parameter of transformation functions
	glm::mat4	MV = glm::rotate(
						glm::rotate(
							glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -2.0f)),
							30.0f, glm::vec3(1.0f, 0.0f, 0.0f)),
					-30.0f, glm::vec3(0.0f, 1.0f, 0.0f));
