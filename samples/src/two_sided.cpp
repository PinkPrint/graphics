...
void init(void)
{
	h_prog = build_program_from_files("two_sided_Blinn_Phong.vert", "two_sided_Blinn_Phong.frag");
...
void display(void)
{
	...
	glUniform3f(glGetUniformLocation(h_prog, "material[0].ambient"), 0.24725, 0.1995, 0.0745);
	glUniform3f(glGetUniformLocation(h_prog, "material[0].diffuse"), 0.75164, 0.60648, 0.22648);
	glUniform3f(glGetUniformLocation(h_prog, "material[0].specular"), 0.628281, 0.555802, 0.366065);
	glUniform1f(glGetUniformLocation(h_prog, "material[0].shininess"), 0.4*128.0);

	// bronze
	glUniform3f(glGetUniformLocation(h_prog, "material[1].ambient"), 0.2125, 0.1275, 0.054);
	glUniform3f(glGetUniformLocation(h_prog, "material[1].diffuse"),  0.714, 0.4284, 0.18144);
	glUniform3f(glGetUniformLocation(h_prog, "material[1].specular"), 0.393548, 0.271906, 0.166721);
	glUniform1f(glGetUniformLocation(h_prog, "material[1].shininess"), 0.2*128.0);
